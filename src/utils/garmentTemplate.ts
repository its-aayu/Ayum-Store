...
const MUG_PRINT_AREA: PrintArea = { xPct: 0.3, yPct: 0.44, wPct: 0.4, hPct: 0.2 };

/**
 * Flat garment mockup templates live in public/assets/custom/ and share their print-area
 * rects with the renderer that generated them (scripts/render-custom-mockups.mjs).
...
export function getGarmentTemplate(category: ProductCategory): { image: string; printArea: PrintArea } | null {
  switch (category) {
    ...
    case 'mug':
      return { image: '/assets/custom/mug-front.png', printArea: MUG_PRINT_AREA };
    default:
      return null;
  }
}
